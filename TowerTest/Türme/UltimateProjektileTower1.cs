...
namespace TowerTest
{
    public class UltimateProjektileTower1:Turm
    {
     public  UltimateProjektileTower1(Spielfeld spiefeld ,Point Position) 
        {
        ...
        public UltimateProjektileTower1() 
        {
            InitTower();
        }
        ...
        public void InitTower() 
        {
            ...
            M_PaintCount = 0;
            M_IReichweite = 150;
            M_Geschosstyp = typeof(Projektile6);
        }
        ...
        public override void OnPaint(Graphics graphics) 
        {
            ...
            graphics.DrawImage(Image.FromFile(Application.StartupPath + "\\Grafiken\\Turm-mit-Laser-geschoss-turm-rot.png"), M_Position.X, M_Position.Y, 20, 20);//(M_Pen, new Rectangle(MiddleTower_Pos, new Size(6, 6)));
            if (M_PaintCount == 0)
            {
            ...
            if (Level <= MaxLevel)
            {
                if (M_Spielfeld.Money > M_UpgradeKosten)
                {
                    switch (Level)
                    {
                        ...
                        case 7: M_Spielfeld.Money -= M_UpgradeKosten; M_UpgradeKosten = 0; M_MaxEinheitToShoot = 30; M_Feuerrate = 7; M_Geschosstyp = typeof(Projektile7); M_IReichweite += 35; break;
                    }
                    M_Level++;
