    ...
    public class SlowTower3:Turm
    {
     public  SlowTower3(Spielfeld spiefeld ,Point Position) 
        ...
        public override void OnPaint(Graphics graphics) 
        {
            ...
            graphics.DrawImage(Image.FromFile(Application.StartupPath + "\\Grafiken\\Turm-mit-Laser-geschoss-turm-grün.png"), M_Position.X, M_Position.Y, 20, 20);//(M_Pen, new Rectangle(MiddleTower_Pos, new Size(6, 6)));
            if (M_PaintCount == 0)
            {
